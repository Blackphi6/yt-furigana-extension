...
assert.deepEqual(
  ...
  { superChatEnabled: true, chatEnabled: false }
);
assert.deepEqual(
  normalizeYtscfState({ superChatEnabled: false, chatEnabled: true }),
  { superChatEnabled: false, chatEnabled: true }
);
...
assert.deepEqual(
  ...
  { superChatEnabled: true, chatEnabled: true }
);
assert.equal(isAnyTargetEnabled({ superChatEnabled: false, chatEnabled: false }), false);
assert.equal(isAnyTargetEnabled({ superChatEnabled: true, chatEnabled: false }), true);
